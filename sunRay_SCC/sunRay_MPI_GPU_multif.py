...
if __name__=="__main__": 
    ...
    jobs = [(0.1,0.15), (0.1,0.5), (0.1,0.8),
            (0.15,0.15), (0.15,0.5), (0.15,0.8),
            (0.35,0.8), (0.35,0.5),(0.35,0.15)]
    
    for _ in range(5):
        for fr in [1.02,1.01,1.005]:
            r0=st.freq_to_R(35e6,fr)[0]
            sunrayMPIGPU(jobs, f_ratio=fr, r0=r0,
